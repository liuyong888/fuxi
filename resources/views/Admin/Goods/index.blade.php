     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 209px;">类型</th>
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
       ...
       <tr class="odd"> 
        ...
        <td class=" "><img src="{{$row->pic}}" with="80px" height="80px"></td> 
        <td class=" ">{{$row->descr}}</td>
        <td class=" ">
        <form name="del" action="/admingoods/{{$row->id}}" method="post" accept-charset="utf-8">          
            {{csrf_field()}}
            {{method_field('DELETE')}}
