            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/adminuserss/create">管理员添加</a></li>
                            <li><a href="/adminuserss">管理员列表</a></li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/article/create">文章添加</a></li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/abs/create">公告添加</a></li>
                            <li><a href="/abs">公告列表</a></li>
                        </ul>
                    </li>
